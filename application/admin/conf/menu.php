...
return	array(	
	...
	'shop'=>array('name'=>'商城','child'=>array(
			...
			array('name' => '保税订单','child'=>array(
					array('name' => '全部订单', 'act'=>'all_order','op'=>'Order'),
					array('name' => '未支付订单', 'act'=>'index','op'=>'Order','class'=>"<span id='num1'></span>"),
					array('name' => '处理中订单', 'act'=>'order1','op'=>'Order','class'=>"<span id='num2'></span>"),
					array('name' => '异常订单', 'act'=>'order2','op'=>'Order','class'=>"<span id='num3'></span>"),
					array('name' => '发货订单', 'act'=>'order3','op'=>'Order','class'=>"<span id='num4'></span>"),
					array('name' => '收货订单', 'act'=>'order4','op'=>'Order','class'=>"<span id='num5'></span>"),
			        array('name' => '完成订单','act'=>'order5','op'=>'Order','class'=>"<span id='num6'></span>"),
			        array('name' => '售后订单','act'=>'order6','op'=>'Order','class'=>"<span id='num7'></span>"),
			        array('name' => '订单日志','act'=>'order_log','op'=>'Order'),
			        array('name' => '订单导出','act'=>'order_search','op'=>'Order'),
			        array('name' => '回收站','act'=>'order7','op'=>'Order'),
			        array('name' => '添加订单','act'=>'add_order','op'=>'Order'),
			)),
			array('name' => '直邮订单','child'=>array(
					array('name' => '全部订单', 'act'=>'all_order','op'=>'OrderBC'),
					array('name' => '未支付订单', 'act'=>'index', 'op'=>'OrderBC','class'=>"<span id='bc1'></span>"),
					array('name' => '处理中订单', 'act'=>'order1', 'op'=>'OrderBC','class'=>"<span id='bc2'></span>"),
					array('name' => '异常订单', 'act'=>'order2', 'op'=>'OrderBC','class'=>"<span id='bc3'></span>"),
					array('name' => '发货订单', 'act'=>'order3', 'op'=>'OrderBC','class'=>"<span id='bc4'></span>"),
					array('name' => '收货订单', 'act'=>'order4','op'=>'OrderBC','class'=>"<span id='bc5'></span>"),
			        array('name' => '完成订单','act'=>'order5','op'=>'OrderBC','class'=>"<span id='bc6'></span>"),
			        array('name' => '售后订单','act'=>'order6','op'=>'OrderBC','class'=>"<span id='bc7'></span>"),
			        array('name' => '订单日志','act'=>'order_log','op'=>'Order'),
			        array('name' => '订单导出','act'=>'order_search','op'=>'OrderBC'),
			        array('name' => '回收站','act'=>'order7','op'=>'OrderBC'),
			        array('name' => '添加订单','act'=>'add_order','op'=>'OrderBC'),
			)),
			array('name' => '普通订单','child'=>array(
					array('name' => '全部订单', 'act'=>'all_order','op'=>'CommonOrder'),
					array('name' => '未支付订单', 'act'=>'index', 'op'=>'CommonOrder','class'=>"<span id='n1'></span>"),
					array('name' => '处理中订单', 'act'=>'common_order1', 'op'=>'CommonOrder','class'=>"<span id='n2'></span>"),
					array('name' => '异常订单', 'act'=>'common_order2', 'op'=>'CommonOrder','class'=>"<span id='n3'></span>"),
					array('name' => '发货订单', 'act'=>'common_order3', 'op'=>'CommonOrder','class'=>"<span id='n4'></span>"),
					array('name' => '收货订单', 'act'=>'common_order4','op'=>'CommonOrder','class'=>"<span id='n5'></span>"),
			        array('name' => '完成订单','act'=>'common_order5','op'=>'CommonOrder','class'=>"<span id='n6'></span>"),
			        array('name' => '售后订单','act'=>'common_order6','op'=>'CommonOrder','class'=>"<span id='n7'></span>"),
			        array('name' => '订单日志','act'=>'order_log','op'=>'Order'),
			        array('name' => '订单导出','act'=>'order_search','op'=>'commonOrder'),
			        array('name' => '回收站','act'=>'common_order7','op'=>'CommonOrder'),
			        array('name' => '添加订单','act'=>'add_order','op'=>'CommonOrder'),
			)),
                    array('name' => '仓库管理','child' => array(
					array('name' => '仓库列表', 'act'=>'warehouseList', 'op'=>'Warehouse'),
//                                        array('name' => '店铺列表', 'act'=>'storeList', 'op'=>'Warehouse'),
                                        array('name' => 'API列表', 'act'=>'apiList', 'op'=>'Warehouse'),
                                        // array('name' => '默认关区', 'act'=>'defaultCus', 'op'=>'Warehouse'),
			)),
                        array('name' => '配置管理','child' => array(
					array('name' => '系统配置', 'act'=>'index', 'op'=>'Setting'),
                                        array('name' => '支付配置', 'act'=>'paySetting', 'op'=>'Setting'),
			)),
                        array('name' => '关区管理','child' => array(
					array('name' => '关区列表', 'act'=>'index', 'op'=>'port'),
			)),
			array('name' => '网站地图','child' => array(
					array('name' => '导航管理', 'act'=>'index', 'op'=>'Map'),
			)),
