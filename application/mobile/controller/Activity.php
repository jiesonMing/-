...
class Activity extends MobileBase {
    ...
    */ 
    ...
    public function seckill_list(){
        ...
        $Page = new Page($count ,$pagesize);    //分页类
        $seckill_list=DB::query("select f.goods_id,f.title,g.goods_name,f.price,g.shop_price,f.order_num,f.goods_num from __PREFIX__goods as g inner join __PREFIX__flash_sale as f on g.goods_id = f.goods_id where start_time = $start_time and end_time = $end_time limit ".$Page->firstRow.",".$Page->listRows."");     //获取商品
